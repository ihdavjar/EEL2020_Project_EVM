...
HD_PWD='D:/DD_CHIPS/EVM_TESTER/EVM_TESTER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log evm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source evm.tcl
