...
HD_PWD='D:/DD_CHIPS/EVM_TESTER/EVM_TESTER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log evm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source evm.tcl -notrace
